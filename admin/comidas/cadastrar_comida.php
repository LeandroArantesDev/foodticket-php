        ...
        <form action="../../database/comidas/cadastrar_comida.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="descricao" id="descricao" placeholder="Digite a descrição do alimento" required
                    pattern=".{10,}" title="Descrição com pelo menos 10 caracteres">
            </div>

            <div class="form-group">
                <label for="preco">Preço</label>
                <input type="number" name="preco" id="preco" placeholder="Digite o preço do alimento" required
                    min="0.01" step="0.01" title="Informe um valor válido (mínimo: 0.01)">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ingredientes" id="ingredientes"
                    placeholder="Digite os ingredientes do alimento" required pattern=".{5,}"
                    title="Ingredientes com pelo menos 5 caracteres">
            </div>
